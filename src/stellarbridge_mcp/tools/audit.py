...
Response objects follow the OCSF (Open Cybersecurity Schema Framework) shape:
  id, timestamp, actor, actor_type (human|agent|api), action,
  fileName, fileHash, orgId, userId
"""
...
def get_audit_logs(
    ...
    file_name: Annotated[str | None, "Filter by name of the file involved in the event"] = None,
    ...
    - actor_type: one of "human", "agent", or "api"
    - action: type of action performed
    - fileName / fileHash: file involved (if applicable)
